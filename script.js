...
const dict = {
  ru: {
    ...
    "c1.b":"продавец в магазине","c1.a":"$1000/мес как фриланс-дизайнер","c1.t":"5 месяцев после курса",
    "c1.q":"«Думала не смогу, но Асад так разложил всё по полочкам, что после открытого урока поняла — это моё»",
    "c2.b":"менеджер в банке","c2.a":"$1500/мес + 4 проекта в работе","c2.t":"6 месяцев после курса",
    "c2.q":"«Думал поздно менять профессию в 28. Оказалось — самое время.»",
    "c3.b":"студентка медфака","c3.a":"$800 на удалёнке + диплом","c3.t":"4 месяца после курса",
    "c3.q":"«Совмещаю с учёбой — теперь не зависну от родителей.»",
    "c4.b":"в декрете, без дохода","c4.a":"$900/мес из дома","c4.t":"7 месяцев после курса",
    "c4.q":"«Ребёнок спит — я работаю. Это и есть моя свобода.»",
  ...
  uz: {
    ...
    "c1.b":"do‘konda sotuvchi","c1.a":"$1000/oy frilans-dizayner sifatida","c1.t":"Kursdan 5 oy keyin",
    "c1.q":"«Qila olmayman deb o‘yladim, lekin Asad shunday tushuntirdiki, ochiq darsdan keyin tushundim — bu meniki»",
    "c2.b":"bankda menejer","c2.a":"$1500/oy + 4 ta ishdagi loyiha","c2.t":"Kursdan 6 oy keyin",
    "c2.q":"«28 yoshda kasb almashtirish kech deb o‘ylagandim. Aslida — aynan vaqti.»",
    "c3.b":"tibbiyot fakulteti talabasi","c3.a":"$800 masofadan + diplom","c3.t":"Kursdan 4 oy keyin",
    "c3.q":"«O‘qish bilan birga olib boryapman — endi ota-onamga bog‘liq emasman.»",
    "c4.b":"dekretda, daromadsiz","c4.a":"$900/oy uydan","c4.t":"Kursdan 7 oy keyin",
    "c4.q":"«Bola uxlaganda men ishlayman. Mana shu mening erkinligim.»",
